...
object ChessApi {
    ...
    fun getPieceFromIndex(board: Board, index: Int): PieceType? = PieceType.fromCIntNullable(nativeBindings.chess_get_piece_from_index(board.value, index))
    fun getPieceFromBitboard(board: Board, bitBoard: BitBoard): PieceType? = PieceType.fromCIntNullable(nativeBindings.chess_get_piece_from_bitboard(board.value, bitBoard.value))
