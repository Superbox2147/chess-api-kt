...
| `getPieceFromIndex(board: Board, index: Int): PieceType`                        | Returns the type of the piece in the given index. Indices correspond to board tiles beginning at a1, increasing first at the letter and secondarily at the number, each wraparound of the letter increases the number. Indices should be between 0-63.  |
...
| `getColorFromIndex(board: Board, index: Int): PlayerColor`                      | Returns the color of the piece in the given index. Indices correspond to board tiles beginning at a1, increasing first at the letter and secondarily at the number, each wraparound of the letter increases the number. Indices should be between 0-63. |
| `getColorFromBitboard(board: Board, bitBoard: BitBoard): PlayerColor`           | Returns the color of the piece in the set bit of the given `BitBoard`, the `BitBoard` is expected to have only one bit set.                                                                                                                             |
